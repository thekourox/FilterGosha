...
## 🗂 لینک هوشمند اشتراک (وب + کلاینت)

هر اشتراک یک **لینک واحد هوشمند** (`/sub/{uuid}`) دارد:
* **در مرورگر**: باز کردن این لینک در مرورگر، صفحه عمومی و زیبای جزئیات اشتراک (شامل وضعیت مصرف، حجم کل، زمان انقضا، لیست کانفیگ‌ها و QR Code) را نمایش می‌دهد.
* **در کلاینت‌ها (V2rayN, Shadowrocket, Sing-Box, Hiddify و...)**: وارد کردن این لینک در کلاینت‌های اتصال، به صورت خودکار تمام کانفیگ‌های فعال اشتراک را به صورت feed لود می‌کند.
...
| متغیر | توضیح | پیش‌فرض |
|---|---|---|
| `ADMIN_PASSWORD` | رمز عبور ورود به داشبورد وب | `FilterGoshaKING` |
...
FilterGosha · پشتیبانی: [لینک گروه](https://t.me/FilterGosha)
با استار دادن به این پروژه از ما حمایت کنید
